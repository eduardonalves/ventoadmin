...
$(document).ready(function(e) {
		...
		<?php if(isset($_SESSION['operador']) && $_SESSION['operador_inserir'] != 1 ){ ?>
...
<img src="img/LOGO-VENTO-p.png" border="0" style="cursor:pointer" onClick="window.location = 'adm.php'" />
...
<td onClick="window.location = 'sair.php'">SAIR</td>
