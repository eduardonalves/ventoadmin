...
$fipeVeiculo = $_POST["fipeVeiculo"];
$fipeMarca = $_POST["fipeMarca"];
$fipeModelo = $_POST["fipeModelo"];
$fipeAno_modelo = $_POST["fipeAno_modelo"];
$motoCilindrada = $_POST["motoCilindrada"];
$adicionalGnv = $_POST["adicionalGnv"];
$adicionalRastreador = $_POST["adicionalRastreador"];
$valorVeiculo = $_POST["valorVeiculo"];
$txAdesao = $_POST["txAdesao"];
...
function checkoperador(m){
	...
	$('#loadoperadores').load('check-operadores-protection.php?m='+m+'&g=0003');
...
<td align="right"><img src="img/voltar.png" style="cursor:pointer" onclick="window.location = '?p=protection'" /></td>
...
<?
	if($USUARIO["tipo_usuario"]=="MONITOR")
	{
		...
		$conMONITORES = $conexao->query("SELECT * FROM usuarios WHERE tipo_usuario = 'MONITOR' && grupo LIKE '%0007%' && status='ATIVO' && id=" . $USUARIO["id"] . " order by nome");
	
	}else{
	
		$conMONITORES = $conexao->query("SELECT * FROM usuarios WHERE (tipo_usuario = 'MONITOR' || tipo_usuario = 'MONITORBO') && grupo LIKE '%0007%' && status='ATIVO' order by nome");
	}
...
<span class="erro" id="emonitor" style="display:none">Por favor, selecione o consultor responsável pelo operador que fez a venda!</span>
...
<tr class="lineCilindradas" style="display:none;">
	<td>Cilindradas:</td>
	<td>
...
<tr class="lineFipeVal " style="display:none;">
	<td>Valor FIPE:</td>
	<td class="fipeVal clearOnChange_fipeVeiculo clearOnChange_fipeMarca clearOnChange_fipeModelo"></td>
	<input type="hidden" name="valorVeiculo" value="" />
</tr>

<tr class="lineFipeCota" style="display:none;">
	<td>Cota de Part.:</td>
	<td class="fipeCota clearOnChange_fipeVeiculo clearOnChange_fipeMarca clearOnChange_fipeModelo"></td>
</tr>
...
<tr align="left">
	...
	<td>
		...
		<span id="iBoxAdicionalGnv">
			<input class="eventClick" type="checkbox" id="adicionalGnv" name="adicionalGnv" value="gnv" /><label for="adicionalGnv" style="font-size:14px;">Gás Natural Veicular</label>
		</span>
		
		<span id="iBoxAdicionalRastreador">
			<input class="eventClick" type="checkbox" id="adicionalRastreador" name="adicionalRastreador" value="rastreador" checked="checked" /><label for="adicionalRastreador" style="font-size:14px;">Rastreador</label>
		</span>
...
<tr align="left" id="linetxAdesao">
	<td>Taxa Adesão:</td>
	<td id="txAdesao" class="clearOnChange_fipeVeiculo clearOnChange_fipeMarca clearOnChange_fipeModelo"></td>
	
	<input type="hidden" name="txAdesao" value="" />

</tr>

<tr align="left" id="lineValorMensalidade">
	<td>Mensalidade:</td>
	<td id="valorMensalidade" class="clearOnChange_fipeVeiculo clearOnChange_fipeMarca clearOnChange_fipeModelo"></td>
	
	<td><input type="hidden" name="valorMensalidade" value="" /></td>
...
<td>
	...
	<input type="radio" id="venci2" name="vencimento" value="10" /> 10
	<input type="radio" id="venci3" name="vencimento" value="15" /> 15
	<input type="radio" id="venci4" name="vencimento" value="20" /> 20 
	<input type="radio" id="venci5" name="vencimento" value="25" /> 25 
