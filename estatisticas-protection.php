...
<? if($USUARIO['tipo_usuario']=="ADMINISTRADOR_INVALID"){ ?>
| Tipo de Venda: 
...
if($USUARIO['tipo_usuario'] == 'SUPERVISOR'){
	...
	$conMONITORES = $conexao->query("SELECT usuarios.nome AS nomemonitor,
											...
											COUNT(if((vendas_clarotv.data_instalacao LIKE '%".$ano.$mes."%' && 
													  ...
													  vendas_clarotv.pagamento = 'DINHEIRO'),1,NULL)) AS vendasfinalizadasboleto,
											...
											COUNT(if((vendas_clarotv.data_instalacao LIKE '%".$ano.$mes."%' && 
													  ...
													  vendas_clarotv.pagamento = 'PAGSEGURO'),1,NULL)) AS vendasfinalizadaspe
...
<td bgcolor="#ceedfc" width="150px">Dinheiro / Cartão / Pagseguro</td>
