...
<img src="img/record.png" width="20" align="absmiddle" style="cursor:pointer" title="Inserir Gravação" onClick="window.location = 'http://172.16.0.30/vento-adm/upload-gravacao-simples-clarofixo.php?id=<?= $linha['id'];?>&u=<?= $USUARIO['id'];?>'" /> <span style="font-size:13px;">Inserir Gravação </span>
...
<? } else if(($editar == '1' || $editar_instalacao == '1') && $linha['status'] == 'ENVIAR GRAVAÇÃO') { ?>
