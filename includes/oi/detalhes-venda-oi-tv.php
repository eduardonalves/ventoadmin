...
<select id="pagamento" name="pagamento"  onchange="verificapagamento(this.value);">
...
<select name="plano" id="plano" onchange="verificaplano();">

<option value=""></option>

<? if($linha['plano'] == 'OI TV MEGA HD'){ ?><option value="OI TV MEGA HD" selected="selected">OI TV MEGA HD</option><? }?>

<? if($linha['plano'] == 'OI TV MEGA HBO/MAX HD'){ ?><option value="OI TV MEGA HBO/MAX HD" selected="selected">OI TV MEGA HBO/MAX HD</option><? }?>

<? if($linha['plano'] == 'OI TV MEGA TELECINE HD'){ ?><option value="OI TV MEGA TELECINE HD" selected="selected">OI TV MEGA TELECINE HD</option><? }?>

<? if($linha['plano'] == 'OI TV MEGA CINEMA HD'){ ?><option value="OI TV MEGA CINEMA HD" selected="selected">OI TV MEGA CINEMA HD</option><? }?>

<? if($linha['plano'] == 'OI TV MAIS HD'){ ?><option value="OI TV MAIS HD" selected="selected">OI TV MAIS HD</option><? }?>

<? if($linha['plano'] == 'OI TV MAIS TELECINE HD'){ ?><option value="OI TV MAIS TELECINE HD" selected="selected">OI TV MAIS TELECINE HD</option><? }?>

<? if($linha['plano'] == 'OI TV MAIS HBO/MAX HD'){ ?><option value="OI TV MAIS HBO/MAX HD" selected="selected">OI TV MAIS HBO/MAX HD</option><? }?>

<? if($linha['plano'] == 'OI TV MAIS CINEMA HD'){ ?><option value="OI TV MAIS CINEMA HD" selected="selected">OI TV MAIS CINEMA HD</option><? }?>

<option value="OI TV START HD" <? if($linha['plano'] == 'OI TV START HD'){ ?> selected="selected"<? }?>>OI TV START HD</option>
<option value="OI TV MIX HD" <? if($linha['plano'] == 'OI TV MIX HD'){ ?> selected="selected"<? }?>>OI TV MIX HD</option>
<option value="OI TV MIX HBO MAX HD" <? if($linha['plano'] == 'OI TV MIX HBO MAX HD'){ ?> selected="selected"<? }?>>OI TV MIX HBO MAX HD</option>
<option value="OI TV MIX TELECINE HD" <? if($linha['plano'] == 'OI TV MIX TELECINE HD'){ ?> selected="selected"<? }?>>OI TV MIX TELECINE HD</option>
<option value="OI TV MIX CINEMA HD" <? if($linha['plano'] == 'OI TV MIX CINEMA HD'){ ?> selected="selected"<? }?>>OI TV MIX CINEMA HD</option>
<option value="OI TV MIX FUTEBOL HD" <? if($linha['plano'] == 'OI TV MIX FUTEBOL HD'){ ?> selected="selected"<? }?>>OI TV MIX FUTEBOL HD</option>
<option value="OI TV MIX CINEMA FUTEBOL HD" <? if($linha['plano'] == 'OI TV MIX CINEMA FUTEBOL HD'){ ?> selected="selected"<? }?>>OI TV MIX CINEMA FUTEBOL HD</option>

<option value="OI TV TOTAL HD" <? if($linha['plano'] == 'OI TV TOTAL HD'){ ?> selected="selected"<? }?>>OI TV TOTAL HD</option>
<option value="OI TV TOTAL HBO MAX HD" <? if($linha['plano'] == 'OI TV TOTAL HBO MAX HD'){ ?> selected="selected"<? }?>>OI TV TOTAL HBO MAX HD</option>
<option value="OI TV TOTAL TELECINE HD" <? if($linha['plano'] == 'OI TV TOTAL TELECINE HD'){ ?> selected="selected"<? }?>>OI TV TOTAL TELECINE HD</option>
<option value="OI TV TOTAL CINEMA HD" <? if($linha['plano'] == 'OI TV TOTAL CINEMA HD'){ ?> selected="selected"<? }?>>OI TV TOTAL CINEMA HD</option>
<option value="OI TV TOTAL FUTEBOL HD" <? if($linha['plano'] == 'OI TV TOTAL FUTEBOL HD'){ ?> selected="selected"<? }?>>OI TV TOTAL FUTEBOL HD</option>
<option value="OI TV TOTAL CINEMA FUTEBOL HD" <? if($linha['plano'] == 'OI TV TOTAL CINEMA FUTEBOL HD'){ ?> selected="selected"<? }?>>OI TV TOTAL CINEMA FUTEBOL HD</option>
...
<? } else if(($_GET['e'] == '1') && $linha['status'] == 'DEVOLVIDO') { ?>
