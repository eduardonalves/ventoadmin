...
function verificaplano(){
    ...
    var oifixo = document.getElementById('oifixo').value;
...
if(oifixo=="")
{
	...
	alert('Informe se a pessoa já é cliente Oi Fixo ou não.');
	
	document.getElementById('oifixo').value = "";
...
if(oifixo=="")
{
	...
	alert("Informe se o cliente já possui Oi Fixo.");
...
if(plano=="")
{
	...
	alert("Informe o plano escolhido.");
...
<img src="img/record.png" width="20" align="absmiddle" style="cursor:pointer" title="Inserir Gravação" onClick="window.location = 'http://vem.vento-consulting.com/upload-gravacao-simples-oi.php?id=<?= $linha['id'];?>&u=<?= $USUARIO['id'];?>'" /> <span style="font-size:13px;">Inserir Gravação </span>
