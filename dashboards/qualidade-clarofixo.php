...
*/
      ...
      END AS status_processo
		FROM vendas_clarotv vendas
		LEFT OUTER JOIN qualidades ON ( qualidades.qualidade_id = (Select q.qualidade_id from qualidades q where ((q.novo_numero=vendas.novoNumero && q.os=vendas.os) || (q.novo_numero=vendas.novoNumero && q.os='')) && q.status_data>=CONCAT(SUBSTRING(vendas.data_venda,1,4), \"-\", SUBSTRING(vendas.data_venda,5,2), \"-\", SUBSTRING(vendas.data_venda,7,2), \" 00:00:00\") order by status_portal desc, q.status_data desc, qualidade_id, q.created desc limit 1) )

		LEFT OUTER JOIN qualidades qxerox ON ( qxerox.qualidade_id = (Select qx.qualidade_id from qualidades qx where (qx.novo_numero=vendas.novoNumero && qx.os=vendas.os && qx.status_data>=CONCAT(SUBSTRING(vendas.data_venda,1,4), \"-\", SUBSTRING(vendas.data_venda,5,2), \"-\", SUBSTRING(vendas.data_venda,7,2), \" 00:00:00\")) order by qx.status_xerox desc limit 1) )");
...
/* **** Consultas para vendas do mes selecionado que estao finalizadas ********
...
/* **** Consultas para vendas que foram finalizadas no mes selecionado ********/
$totalNA = mysql_result( $conexao->query("Select count(id) from view_vendas where status_qualidade = '0' && data_instalacao like '" . $ano . $mes . "%' && status='FINALIZADA' && produto='3'"), 0 );
$totalIntencionadas = mysql_result( $conexao->query("Select count(id) from view_vendas where status_qualidade = '1' && data_instalacao like '" . $ano . $mes . "%' && status='FINALIZADA' && produto='3'"), 0 );
$totalConfirmadas = mysql_result( $conexao->query("Select count(id) from view_vendas where status_qualidade = '2' && data_instalacao like '" . $ano . $mes . "%' && status='FINALIZADA' && produto='3'"), 0 );
$totalAtivadas = mysql_result( $conexao->query("Select count(id) from view_vendas where status_qualidade = '3' && data_instalacao like '" . $ano . $mes . "%' && status='FINALIZADA' && produto='3'"), 0 );
$totalComissionadas = mysql_result( $conexao->query("Select count(id) from view_vendas where status_qualidade = '4' && data_instalacao like '" . $ano . $mes . "%' && status='FINALIZADA' && produto='3'"), 0 );
$totalEstornadas = mysql_result( $conexao->query("Select count(id) from view_vendas where status_qualidade = '5' && data_instalacao like '" . $ano . $mes . "%' && status='FINALIZADA' && produto='3'"), 0 );
/****************************/
...
<div id="chart1" class="chart" onMouseOver="showinfo('i1')" onMouseOut="hideinfo('i1')" onClick="javascript:window.open('../adm?ve=2&me=<?php echo $mes; ?>&an=<?php echo $ano; ?>&p=clarofixo&o=&m=&t=&f=&s=FINALIZADA&v=&i=&de=&di=&di2=&tpv=&tpentrega=&b=&ebt=0','_top');">
...
<div id="chart2" class="chart" onMouseOver="showinfo('i2')" onMouseOut="hideinfo('i2')" onClick="javascript:window.open('../adm?ve=2&me=<?php echo $mes; ?>&an=<?php echo $ano; ?>&p=clarofixo&o=&m=&t=&f=&s=FINALIZADA&v=&i=&de=&di=&di2=&tpv=&tpentrega=&b=&ebt=1','_top');">
...
<div id="chart3" class="chart" onMouseOver="showinfo('i3')" onMouseOut="hideinfo('i3')" onClick="javascript:window.open('../adm?ve=2&me=<?php echo $mes; ?>&an=<?php echo $ano; ?>&p=clarofixo&o=&m=&t=&f=&s=FINALIZADA&v=&i=&de=&di=&di2=&tpv=&tpentrega=&b=&ebt=2','_top');">
...
<div id="chart4" class="chart" onMouseOver="showinfo('i4')" onMouseOut="hideinfo('i4')"   onClick="javascript:window.open('../adm?ve=2&me=<?php echo $mes; ?>&an=<?php echo $ano; ?>&p=clarofixo&o=&m=&t=&f=&s=FINALIZADA&v=&i=&de=&di=&di2=&tpv=&tpentrega=&b=&ebt=3','_top');">
...
<div id="chart5" class="chart" onMouseOver="showinfo('i5')" onMouseOut="hideinfo('i5')" onClick="javascript:window.open('../adm?ve=2&me=<?php echo $mes; ?>&an=<?php echo $ano; ?>&p=clarofixo&o=&m=&t=&f=&s=FINALIZADA&v=&i=&de=&di=&di2=&tpv=&tpentrega=&b=&ebt=4','_top');">
...
<div id="chart6" class="chart" onMouseOver="showinfo('i6')" onMouseOut="hideinfo('i6')" onClick="javascript:window.open('../adm?ve=2&me=<?php echo $mes; ?>&an=<?php echo $ano; ?>&p=clarofixo&o=&m=&t=&f=&s=FINALIZADA&v=&i=&de=&di=&di2=&tpv=&tpentrega=&b=&ebt=5','_top');">
