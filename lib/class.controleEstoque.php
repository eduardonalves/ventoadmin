...
class controleEstoque {
	...
	public function getQuantTotalParceiroReposicao($id_parceiro="", $dataInicio="0000-00-00 00:00:00", $dataFinal="") {
		...
		$query = "select count(*) as total from reposicoes_clarofixo
				where monitor_venda='$id_parceiro' && data BETWEEN '$dataInicio' AND '$dataFinal'";
		
		$repSql = $this->conexao->query($query);
		
		$quantidade = mysql_result($repSql,0,'total');
