...
$con1 = $conexao->query("SELECT * FROM vendas_clarotv  WHERE produto = '4' && data LIKE '%".$ano.$mes.$dia."%' && plano = 'OI TV MEGA HD' && monitor LIKE '%".$loginMONITOR."%'");
$total1 = mysql_num_rows($con1);

$con2 = $conexao->query("SELECT * FROM vendas_clarotv  WHERE produto = '4' && data LIKE '%".$ano.$mes.$dia."%' && plano = 'OI TV MEGA HBO/MAX HD' && monitor LIKE '%".$loginMONITOR."%'");
$total2  = mysql_num_rows($con2);

$con3 = $conexao->query("SELECT * FROM vendas_clarotv  WHERE produto = '4' && data LIKE '%".$ano.$mes.$dia."%' && plano = 'OI TV MEGA TELECINE HD' && monitor LIKE '%".$loginMONITOR."%'");
$total3  = mysql_num_rows($con3);

$con4 = $conexao->query("SELECT * FROM vendas_clarotv  WHERE produto = '4' && data LIKE '%".$ano.$mes.$dia."%' && plano = 'OI TV MEGA CINEMA HD' && monitor LIKE '%".$loginMONITOR."%'");
$total4  = mysql_num_rows($con4);

$con5 = $conexao->query("SELECT * FROM vendas_clarotv  WHERE produto = '4' && data LIKE '%".$ano.$mes.$dia."%' && plano = 'OI TV MAIS HD' && monitor LIKE '%".$loginMONITOR."%'");
$total5  = mysql_num_rows($con5);

$con6 = $conexao->query("SELECT * FROM vendas_clarotv  WHERE produto = '4' && data LIKE '%".$ano.$mes.$dia."%' && plano = 'OI TV MAIS TELECINE HD' && monitor LIKE '%".$loginMONITOR."%'");
$total6  = mysql_num_rows($con6);

$con7 = $conexao->query("SELECT * FROM vendas_clarotv  WHERE produto = '4' && data LIKE '%".$ano.$mes.$dia."%' && plano = 'OI TV MAIS HBO/MAX HD' && monitor LIKE '%".$loginMONITOR."%'");
$total7  = mysql_num_rows($con7);

$con8 = $conexao->query("SELECT * FROM vendas_clarotv  WHERE produto = '4' && data LIKE '%".$ano.$mes.$dia."%' && plano = 'OI TV MAIS CINEMA HD' && monitor LIKE '%".$loginMONITOR."%'");
