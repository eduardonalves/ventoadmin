...
window.location = 'http://vem.techinmove.com.br/detalhes-venda-net.php?id=<?= $_GET['id'];?>';
</script>	
...
<table border="0">
<form name="gravacoes" action="http://172.16.0.30/vento-adm/upload-gravacao-simples-net-br.php?id=<?= $_GET['id'];?>&u=<?= $_GET['u'];?>" enctype="multipart/form-data" method="post">
