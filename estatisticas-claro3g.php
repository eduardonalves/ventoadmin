...
<td title="Data Início" onclick="window.location = '?p=estatisticas-claro3g&m=<?= $_GET['m'];?>&tipovenda=<?= $_GET['tipovenda'];?>&an=<?= $_GET['an'];?>&es=<?= $_GET['es'];?>&o=<? if($_GET['o'] == 'operadorData ASC'){ echo 'operadorData DESC'; } else { echo 'operadorData ASC'; }?>'">Data Início <? if($_GET['o'] == 'operadorData ASC'){ ?><img src="img/seta-u.png" /> <? } else if($_GET['o'] == 'operadorData DESC'){ ?> <img src="img/seta-d.png" /> <? } ?></td>



<td title="Tipo Contrato" onclick="window.location = '?p=estatisticas-claro3g&m=<?= $_GET['m'];?>&tipovenda=<?= $_GET['tipovenda'];?>&an=<?= $_GET['an'];?>&es=<?= $_GET['es'];?>&o=<? if($_GET['o'] == 'operadorContrato ASC'){ echo 'operadorContrato DESC'; } else { echo 'operadorContrato ASC'; }?>'">Tipo Contrato <? if($_GET['o'] == 'operadorContrato ASC'){ ?><img src="img/seta-u.png" /> <? } else if($_GET['o'] == 'operadorContrato DESC'){ ?> <img src="img/seta-d.png" /> <? } ?></td>



<td title="Nome do Operador" onclick="window.location = '?p=estatisticas-claro3g&m=<?= $_GET['m'];?>&tipovenda=<?= $_GET['tipovenda'];?>&an=<?= $_GET['an'];?>&es=<?= $_GET['es'];?>&o=<? if($_GET['o'] != 'operadores.nome DESC'){ echo 'operadores.nome DESC'; } else { echo 'operadores.nome ASC'; }?>'">Nome do Operador <? if($_GET['o'] == 'operadores.nome ASC'){ ?><img src="img/seta-u.png" /> <? } else if($_GET['o'] == 'operadores.nome DESC'){ ?> <img src="img/seta-d.png" /> <? } ?></td>



<td title="Vendas Feitas" onclick="window.location = '?p=estatisticas-claro3g&m=<?= $_GET['m'];?>&tipovenda=<?= $_GET['tipovenda'];?>&an=<?= $_GET['an'];?>&es=<?= $_GET['es'];?>&o=<? if($_GET['o'] == 'vendas ASC'){ echo 'vendas DESC'; } else { echo 'vendas ASC'; }?>'">Vendas Feitas <? if($_GET['o'] == 'vendas ASC'){ ?><img src="img/seta-u.png" /> <? } else if($_GET['o'] == 'vendas DESC'){ ?> <img src="img/seta-d.png" /> <? } ?></td>



<td title="Vendas Finalizadas" onclick="window.location = '?p=estatisticas-claro3g&m=<?= $_GET['m'];?>&tipovenda=<?= $_GET['tipovenda'];?>&an=<?= $_GET['an'];?>&es=<?= $_GET['es'];?>&o=<? if($_GET['o'] == 'conectadas DESC' || $_GET['o'] == ''){ echo 'conectadas ASC'; } else { echo 'conectadas DESC'; }?>'">Vendas Autorizadas <? if($_GET['o'] == 'conectadas DESC' || $_GET['o'] == ''){ ?><img src="img/seta-d.png" /> <? } else if($_GET['o'] == 'conectadas ASC'){ ?> <img src="img/seta-u.png" /> <? } ?></td>
...
<td title="Meta de Qualidade" onclick="window.location = '?p=estatisticas-claro3g&m=<?= $_GET['m'];?>&tipovenda=<?= $_GET['tipovenda'];?>&an=<?= $_GET['an'];?>&es=<?= $_GET['es'];?>&o=<? if($_GET['o'] == 'metaqualidade ASC'){ echo 'metaqualidade DESC'; } else { echo 'metaqualidade ASC'; }?>'">Meta de Qualidade <? if($_GET['o'] == 'metaqualidade ASC'){ ?><img src="img/seta-u.png" /> <? } else if($_GET['o'] == 'metaqualidade DESC'){ ?> <img src="img/seta-d.png" /> <? } ?></td>





<td title="Aproveitamento" onclick="window.location = '?p=estatisticas-claro3g&m=<?= $_GET['m'];?>&tipovenda=<?= $_GET['tipovenda'];?>&an=<?= $_GET['an'];?>&es=<?= $_GET['es'];?>&o=<? if($_GET['o'] == 'aproveitamento ASC'){ echo 'aproveitamento DESC'; } else { echo 'aproveitamento ASC'; }?>'">Aproveitamento <? if($_GET['o'] == 'aproveitamento ASC'){ ?><img src="img/seta-u.png" /> <? } else if($_GET['o'] == 'aproveitamento DESC'){ ?> <img src="img/seta-d.png" /> <? } ?></td></tr>
