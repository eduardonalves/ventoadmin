...
if (precoPromocional != '' && precoPromocional != undefined)
{
...
<td id="rginp"><input type="text" id="rg" name="rg" size="20" /> <!--  <span class="campoobrigatorio" title="Campo ObrigatÃ³rio">*</span> --> Org. Exp: <input type="text" title="Orgão Expedidor" id="orgexp" name="orgexp" size="20" /> <!--  <span class="campoobrigatorio" title="Campo ObrigatÃ³rio">*</span> -->

 Data Exp: <input type="text" title="Data Expedição" id="dataexp" name="dataexp" onKeyPress="mascara(this,data)" maxlength="10" size="20" /> <!--  <span class="campoobrigatorio" title="Campo ObrigatÃ³rio">*</span> 
...
<td><input type="text" name="itelefone2" onKeyPress="mascara(this,telefone)" onchange="mascara(this,telefone)" maxlength="15" size="20" /> 
...
<input type="text" id="input-esn" name="esn" size="20"  maxlength="20" />
