...
$conFACIL = $conexao->query("SELECT * FROM vendas_clarotv  WHERE produto = '".$idPRODUTO."' && data LIKE '%".$ano.$mes.$dia."%' && status = 'RESTRIÇÃO' && plano LIKE '%FACIL%' && monitor LIKE '%".$loginMONITOR."%'");
$totalFACIL = mysql_num_rows($conFACIL);

$conESSENCIAL = $conexao->query("SELECT * FROM vendas_clarotv  WHERE produto = '".$idPRODUTO."' && data LIKE '%".$ano.$mes.$dia."%' && status = 'RESTRIÇÃO' && plano LIKE '%ESSENCIAL%' && monitor LIKE '%".$loginMONITOR."%'");
$totalESSENCIAL  = mysql_num_rows($conESSENCIAL );

$conFAMILIA = $conexao->query("SELECT * FROM vendas_clarotv  WHERE produto = '".$idPRODUTO."' && data LIKE '%".$ano.$mes.$dia."%' && status = 'RESTRIÇÃO' && plano LIKE '%FAMILIA%' && monitor LIKE '%".$loginMONITOR."%'");
