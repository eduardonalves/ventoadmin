...
if( isset($_SESSION['usuario'])){
	...
	echo "window.location = '?p=clarotv';";

} elseif ( isset($_SESSION['operador'])){
	
	echo "window.location = '?p=inserir-dados-clarotv';";
...
<option value=""></option>
<option value="FÁCIL DTV">FÁCIL DTV</option>
<option value="ESSENCIAL DTV">ESSENCIAL DTV</option>
