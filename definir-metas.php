...
include "lib/class.TipoMetaNet.php";


$metas = new TiposMetaNet($conexao);
//$metas->novoTipoMeta('Glauber');
$m = new metasNet($conexao, 1, array('inicio'=>'2014-12-22', 'fim'=>'2015-01-31'));
var_dump($m->getCampos());
//var_dump($metas->desativarTipoMeta(1));
//var_dump($metas->getTiposMetas());
