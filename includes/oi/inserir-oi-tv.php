...
function verificavalor(){
    ...
    if(oifixo == 'SIM'){
		...
		$("#preco_promocional5meses").css('display', 'none');
...
if(pagamento == ''){$('#pagamento').html('<option value=""></option><option value="BOLETO">BOLETO</option><option value="CONTA FIXO">CONTA FIXO</option><option value="DÉBITO">DÉBITO</option>');}
        ...
        else if(plano == "OI TV START HD"){ document.getElementById('valor').value = '39,90'; $("#preco_promocional5meses").html('Preço promocional durante 5 meses, após R$ 69,90.').css('display', 'inline-block') ; }
        else if(plano == "OI TV MIX HD"){ document.getElementById('valor').value = '89,90'; }
        else if(plano == "OI TV MIX HBO MAX HD"){ document.getElementById('valor').value = '124,90'; }
        else if(plano == "OI TV MIX TELECINE HD"){ document.getElementById('valor').value = '134,90'; }
        else if(plano == "OI TV MIX CINEMA HD"){ document.getElementById('valor').value = '169,90'; }
        else if(plano == "OI TV MIX FUTEBOL HD"){ document.getElementById('valor').value = '159,90'; }
        else if(plano == "OI TV MIX CINEMA FUTEBOL HD"){ document.getElementById('valor').value = '239,90'; }
        else if(plano == "OI TV TOTAL HD"){ document.getElementById('valor').value = '109,90'; }
        else if(plano == "OI TV TOTAL HBO MAX HD"){ document.getElementById('valor').value = '144,90'; }
        else if(plano == "OI TV TOTAL TELECINE HD"){ document.getElementById('valor').value = '154,90'; }
        else if(plano == "OI TV TOTAL CINEMA HD"){ document.getElementById('valor').value = '189,90'; }
        else if(plano == "OI TV TOTAL FUTEBOL HD"){ document.getElementById('valor').value = '179,90'; }
        else if(plano == "OI TV TOTAL CINEMA FUTEBOL HD"){ document.getElementById('valor').value = '259,90'; }
    ...
    else if(plano == "OI TV START HD"){ document.getElementById('valor').value = '29,90'; $("#preco_promocional5meses").html('Preço promocional durante 5 meses, após R$ 59,90.').css('display', 'inline-block') ; }
    else if(plano == "OI TV MIX HD"){ document.getElementById('valor').value = '79,90'; }
    else if(plano == "OI TV MIX HBO MAX HD"){ document.getElementById('valor').value = '114,90'; }
    else if(plano == "OI TV MIX TELECINE HD"){ document.getElementById('valor').value = '124,90'; }
    else if(plano == "OI TV MIX CINEMA HD"){ document.getElementById('valor').value = '159,90'; }
    else if(plano == "OI TV MIX FUTEBOL HD"){ document.getElementById('valor').value = '149,90'; }
    else if(plano == "OI TV MIX CINEMA FUTEBOL HD"){ document.getElementById('valor').value = '229,90'; }
    else if(plano == "OI TV TOTAL HD"){ document.getElementById('valor').value = '99,90'; }
    else if(plano == "OI TV TOTAL HBO MAX HD"){ document.getElementById('valor').value = '134,90'; }
    else if(plano == "OI TV TOTAL TELECINE HD"){ document.getElementById('valor').value = '144,90'; }
    else if(plano == "OI TV TOTAL CINEMA HD"){ document.getElementById('valor').value = '179,90'; }
    else if(plano == "OI TV TOTAL FUTEBOL HD"){ document.getElementById('valor').value = '169,90'; }
    else if(plano == "OI TV TOTAL CINEMA FUTEBOL HD"){ document.getElementById('valor').value = '249,90'; }
    ...
    else if(plano == "OI TV START HD"){ document.getElementById('valor').value = ''; $("#preco_promocional5meses").css('display', 'none'); }
    else if(plano == "OI TV MIX HD"){ document.getElementById('valor').value = ''; }
    else if(plano == "OI TV MIX HBO MAX HD"){ document.getElementById('valor').value = ''; }
    else if(plano == "OI TV MIX TELECINE HD"){ document.getElementById('valor').value = ''; }
    else if(plano == "OI TV MIX CINEMA HD"){ document.getElementById('valor').value = ''; }
    else if(plano == "OI TV MIX FUTEBOL HD"){ document.getElementById('valor').value = ''; }
    else if(plano == "OI TV MIX CINEMA FUTEBOL HD"){ document.getElementById('valor').value = ''; }
    else if(plano == "OI TV TOTAL HD"){ document.getElementById('valor').value = ''; }
    else if(plano == "OI TV TOTAL HBO MAX HD"){ document.getElementById('valor').value = ''; }
    else if(plano == "OI TV TOTAL TELECINE HD"){ document.getElementById('valor').value = ''; }
    else if(plano == "OI TV TOTAL CINEMA HD"){ document.getElementById('valor').value = ''; }
    else if(plano == "OI TV TOTAL FUTEBOL HD"){ document.getElementById('valor').value = ''; }
    else if(plano == "OI TV TOTAL CINEMA FUTEBOL HD"){ document.getElementById('valor').value = ''; }
...
if (pagamento == 'BOLETO') {
    ...
    else if(plano == "OI TV START HD"){ document.getElementById('valor').value = '89,90'; }
    else if(plano == "OI TV MIX HD"){ document.getElementById('valor').value = '109,90'; }
    else if(plano == "OI TV MIX HBO MAX HD"){ document.getElementById('valor').value = '144,90'; }
    else if(plano == "OI TV MIX TELECINE HD"){ document.getElementById('valor').value = '154,90'; }
    else if(plano == "OI TV MIX CINEMA HD"){ document.getElementById('valor').value = '189,90'; }
    else if(plano == "OI TV MIX FUTEBOL HD"){ document.getElementById('valor').value = '179,90'; }
    else if(plano == "OI TV MIX CINEMA FUTEBOL HD"){ document.getElementById('valor').value = '259,90'; }
    else if(plano == "OI TV TOTAL HD"){ document.getElementById('valor').value = '129,90'; }
    else if(plano == "OI TV TOTAL HBO MAX HD"){ document.getElementById('valor').value = '164,90'; }
    else if(plano == "OI TV TOTAL TELECINE HD"){ document.getElementById('valor').value = '174,90'; }
    else if(plano == "OI TV TOTAL CINEMA HD"){ document.getElementById('valor').value = '209,90'; }
    else if(plano == "OI TV TOTAL FUTEBOL HD"){ document.getElementById('valor').value = '199,90'; }
    else if(plano == "OI TV TOTAL CINEMA FUTEBOL HD"){ document.getElementById('valor').value = '279,90'; }
    ...
    else if(plano == "OI TV START HD"){ document.getElementById('valor').value = '79,90'; }
    else if(plano == "OI TV MIX HD"){ document.getElementById('valor').value = '99,90'; }
    else if(plano == "OI TV MIX HBO MAX HD"){ document.getElementById('valor').value = '134,90'; }
    else if(plano == "OI TV MIX TELECINE HD"){ document.getElementById('valor').value = '144,90'; }
    else if(plano == "OI TV MIX CINEMA HD"){ document.getElementById('valor').value = '179,90'; }
    else if(plano == "OI TV MIX FUTEBOL HD"){ document.getElementById('valor').value = '169,90'; }
    else if(plano == "OI TV MIX CINEMA FUTEBOL HD"){ document.getElementById('valor').value = '149,90'; }
    else if(plano == "OI TV TOTAL HD"){ document.getElementById('valor').value = '119,90'; }
    else if(plano == "OI TV TOTAL HBO MAX HD"){ document.getElementById('valor').value = '154,90'; }
    else if(plano == "OI TV TOTAL TELECINE HD"){ document.getElementById('valor').value = '164,90'; }
    else if(plano == "OI TV TOTAL CINEMA HD"){ document.getElementById('valor').value = '199,90'; }
    else if(plano == "OI TV TOTAL FUTEBOL HD"){ document.getElementById('valor').value = '189,90'; }
    else if(plano == "OI TV TOTAL CINEMA FUTEBOL HD"){ document.getElementById('valor').value = '269,90'; }
    ...
    else if(plano == "OI TV START HD"){ document.getElementById('valor').value = ''; }
    else if(plano == "OI TV MIX HD"){ document.getElementById('valor').value = ''; }
    else if(plano == "OI TV MIX HBO MAX HD"){ document.getElementById('valor').value = ''; }
    else if(plano == "OI TV MIX TELECINE HD"){ document.getElementById('valor').value = ''; }
    else if(plano == "OI TV MIX CINEMA HD"){ document.getElementById('valor').value = ''; }
...
<option value="OI TV START HD">OI TV START HD</option>
<option value="OI TV MIX HD">OI TV MIX HD</option>
<option value="OI TV MIX HBO MAX HD">OI TV MIX HBO MAX HD</option>
<option value="OI TV MIX TELECINE HD">OI TV MIX TELECINE HD</option>
<option value="OI TV MIX CINEMA HD">OI TV MIX CINEMA HD</option>
<option value="OI TV MIX FUTEBOL HD">OI TV MIX FUTEBOL HD</option>
<option value="OI TV MIX CINEMA FUTEBOL HD">OI TV MIX CINEMA FUTEBOL HD</option>

<option value="OI TV TOTAL HD">OI TV TOTAL HD</option>
<option value="OI TV TOTAL HBO MAX HD">OI TV TOTAL HBO MAX HD</option>
<option value="OI TV TOTAL TELECINE HD">OI TV TOTAL TELECINE HD</option>
<option value="OI TV TOTAL CINEMA HD">OI TV TOTAL CINEMA HD</option>
<option value="OI TV TOTAL FUTEBOL HD">OI TV TOTAL FUTEBOL HD</option>
<option value="OI TV TOTAL CINEMA FUTEBOL HD">OI TV TOTAL CINEMA FUTEBOL HD</option>
...
<td> <span style="font-size:12px; color:#999; font-style:italic">R$</span> <input type="text" id="valor" name="valor" value="" size="8" maxlength="10" /> <span style="font-size:12px; color:#999; font-style:italic">(0,00)</span> <span class="campoobrigatorio" title="Campo Obrigatório">*</span>
 <span style="font-size:12px; display:none" id="preco_promocional5meses"></span>
