...
if ( ( ($editar == '1') || ($_GET['e']=='1' &&  $linha['status']=='SEM CONTATO' && $USUARIO['acesso_usuario']=='EXTERNO') || ($_GET['e']=='1' &&  $linha['status']=='SEM COBERTURA') || ($_GET['e']=='1' &&  $linha['status']=='DEVOLVIDO') ) && ($USUARIO['tipo_usuario'] == 'SUPERVISOR' || $USUARIO['tipo_usuario'] == 'MONITOR' || $USUARIO['tipo_usuario'] == 'ADMINISTRADOR') )  {
?>
