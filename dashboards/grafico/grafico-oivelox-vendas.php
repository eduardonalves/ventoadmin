...
$con1 = $conexao->query("SELECT * FROM vendas_clarotv  WHERE produto = '".$idPRODUTO."' && data LIKE '%".$ano.$mes.$dia."%' && plano = '1MB' && monitor LIKE '%".$loginMONITOR."%'");
$total1 = mysql_num_rows($con1);

$con2 = $conexao->query("SELECT * FROM vendas_clarotv  WHERE produto = '".$idPRODUTO."' && data LIKE '%".$ano.$mes.$dia."%' && plano = '2MB' && monitor LIKE '%".$loginMONITOR."%'");
$total2  = mysql_num_rows($con2);

$con3 = $conexao->query("SELECT * FROM vendas_clarotv  WHERE produto = '".$idPRODUTO."' && data LIKE '%".$ano.$mes.$dia."%' && plano = '5MB' && monitor LIKE '%".$loginMONITOR."%'");
$total3  = mysql_num_rows($con3);

$con4 = $conexao->query("SELECT * FROM vendas_clarotv  WHERE produto = '".$idPRODUTO."' && data LIKE '%".$ano.$mes.$dia."%' && plano = '10MB' && monitor LIKE '%".$loginMONITOR."%'");
$total4 = mysql_num_rows($con4);

$con5 = $conexao->query("SELECT * FROM vendas_clarotv  WHERE produto = '".$idPRODUTO."' && data LIKE '%".$ano.$mes.$dia."%' && plano = '15MB' && monitor LIKE '%".$loginMONITOR."%'");
$total5  = mysql_num_rows($con5);

$con6 = $conexao->query("SELECT * FROM vendas_clarotv  WHERE produto = '".$idPRODUTO."' && data LIKE '%".$ano.$mes.$dia."%' && plano = '20MB' && monitor LIKE '%".$loginMONITOR."%'");
