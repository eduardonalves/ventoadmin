...
while($r = mysql_fetch_array($result))
{
	...
	$query = "Select * from ESNsEntradas WHERE esn='$esn' && status='Em Estoque'";
	...
	echo "<br>". $entrada["id_esnsentrada"]. $entrada["status"]." ID: ". $r["id"]." Monitor: ".$r["monitor"] . " ". "ESN: ". $r["esn"]."Aparelho: " . $aparelho;
	/*
$query = "Select * from vendas_clarotv INNER JOIN usuarios ON (usuarios.id=vendas_clarotv.monitor) WHERE esn!='' && vendas_clarotv.status='FINALIZADA' order by usuarios.nome";
	$data = "21/11/2013";
