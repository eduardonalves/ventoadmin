...
<option value=""></option>
<option value="FÁCIL DTV" <? if($linha['plano'] == 'FÁCIL DTV'){ ?> selected="selected" <? }?>>FÁCIL DTV</option>
<option value="ESSENCIAL DTV" <? if($linha['plano'] == 'ESSENCIAL DTV'){ ?> selected="selected" <? }?>>ESSENCIAL DTV</option>
...
<td>
<img src="img/play-icon.png" width="20" align="absmiddle" style="cursor:pointer" title="Ouvir Gravação" onClick="javascript:window.location = 'http://172.16.0.30/audio/clarotv/orig/<?= $gravacaoRE;?>'" /> <span style="font-size:13px;">Ouvir Gravação </span>
<br />
...
<img src="img/record.png" width="20" align="absmiddle" style="cursor:pointer" title="Inserir Gravação" onClick="window.location = 'upload-gravacao-simples.php?id=<?= $linha['id'];?>&u=<?= $USUARIO['id'];?>'" /> <span style="font-size:13px;">Inserir Gravação </span>
...
<? if($_GET['e'] == '1' && ($USUARIO['tipo_usuario'] == 'ADMINISTRADOR' || $USUARIO['id'] == 3150)) {?>
