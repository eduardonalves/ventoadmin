					...
					<form class="dadosDaVenda" method="post" action="/admin/dadosdavenda/inserir">
						...
						<div class="formDados">
							...
							<div class="formDados">
								...
								<label class="" for="">Plano</label>

				                <select name="plano" id="plano" onChange="verificaplano(this.value)">

									<option value="10GB" <? if($val['plano'] == '10GB'){ ?> selected="selected" <? }?>>10GB</option>

									<option value="5GB" <? if($val['plano'] == '5GB'){ ?> selected="selected" <? }?>>5GB</option>

									<option value="3GB" <? if($val['plano'] == '3GB'){ ?> selected="selected" <? }?>>3GB</option>

									<option value="2GB" <? if($val['plano'] == '2GB'){ ?> selected="selected" <? }?>>2GB</option>
							...
							<div class="formDados">
								...
								<select  id="field44"  name="vencimento">
									...
									<option value="5"<? if($val['vencimento'] == '5'){ ?>selected="selected" <? }?>>5</option>

									<option value="10"<? if($val['vencimento'] == '10'){ ?>selected="selected" <? }?>>10</option>

									<option value="12"<? if($val['vencimento'] == '12'){ ?>selected="selected" <? }?>>12</option>

									<option value="20"<? if($val['vencimento'] == '20'){ ?>selected="selected" <? }?>>20</option>

									<option value="24"<? if($val['vencimento'] == '24'){ ?>selected="selected" <? }?>>24</option>
							...
							<div class="formDados">
								...
								<textarea id="" name="obs" style="width: 350px; height:100px; margin-bottom: 10px; padding: 4px; color:#999;"><?= $val['obs']?></textarea>
							...
							<div class="formDados">
								...
								<input type="text" placeholder="" id="" name="valor" value="<?=$val['valor']?>"/>
							...
							<div class="formDados">
								...
								<select name="motivorestricao" id="motivorestricao" class="restricao">

									<option value=""></option>

									<option value="SPC" <? if($val['motivo_restricao'] == 'SPC'){?>selected="selected"<? } ?>>SPC</option>

									<option value="SERASA" <? if($val['motivo_restricao'] == 'SERASA'){?>selected="selected"<? } ?>>SERASA</option>

									<option value="1052" <? if($val['motivo_restricao'] == '1052'){?>selected="selected"<? } ?>>1052</option>

									<option value="Politicas Internas" <? if($val['motivo_restricao'] == 'Politicas Internas'){?>selected="selected"<? } ?>>Politicas Internas</option>

									<option value="Politicas de Segurança" <? if($val['motivo_restricao'] == 'Politicas de Segurança'){?>selected="selected"<? } ?>>Politicas de Segurança</option>

									<option value="Consultas Excedidas" <? if($val['motivo_restricao'] == 'Consultas Excedidas'){?>selected="selected"<? } ?>>Consultas Excedidas</option>

									<option value="Fraude" <? if($val['motivo_restricao'] == 'Fraude'){?>selected="selected"<? } ?>>Fraude</option>

									<option value="Limite Excedido" <? if($val['motivo_restricao'] == 'Limite Excedido'){?>selected="selected"<? } ?>>Limite Excedido</option>

									<option value="Regularizar CPF" <? if($val['motivo_restricao'] == 'Regularizar CPF'){?>selected="selected"<? } ?>>Regularizar CPF</option>
							...
							<div class="formDados">
								...
								<select name="motivocancelamento" id="motivocancelamento" class="cancelamento">
