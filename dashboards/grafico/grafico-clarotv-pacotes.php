...
$conFACIL = $conexao->query("SELECT * FROM vendas_clarotv  WHERE data_instalacao LIKE '%".$ano.$mes.$dia."%' && status = 'CONECTADO' && plano LIKE '%FACIL%' && monitor LIKE '%".$loginMONITOR."%'");
$totalFACIL = mysql_num_rows($conFACIL);

$conESSENCIAL = $conexao->query("SELECT * FROM vendas_clarotv  WHERE data_instalacao LIKE '%".$ano.$mes.$dia."%' && status = 'CONECTADO' && plano LIKE '%ESSENCIAL%' && monitor LIKE '%".$loginMONITOR."%'");
$totalESSENCIAL  = mysql_num_rows($conESSENCIAL );

$conFAMILIA = $conexao->query("SELECT * FROM vendas_clarotv  WHERE data_instalacao LIKE '%".$ano.$mes.$dia."%' && status = 'CONECTADO' && plano LIKE '%FAMILIA%' && monitor LIKE '%".$loginMONITOR."%'");
