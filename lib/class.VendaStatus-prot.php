...
class VendaStatus extends VentoAdmin{
	...
	private $statusLabels = array (
								...
								7 => array(
									...
									'AGENDAR INSTALAÇÃO' => 'Agendar Instalação',
									'REAGENDAR INSTALAÇÃO' => 'Reagendar Instalação',
									'INSTALADO' => 'Instalado',
									'CANCELADO' => 'Cancelado',
									'FINALIZADA' => 'Finalizada'
	...
	private $fluxo =  array (
							...
							7 => array(
							'PRE-ANALISE' => array(),
								'AGENDADO' => array('REAGENDADO', 'VISTORIAR', 'CANCELADO'),
								'REAGENDADO' => array('CANCELADO'),
								'VISTORIAR' => array('INSERIR DOCUMENTOS'),
								'INSERIR DOCUMENTOS' => array('FINALIZADA'),
								'AGENDAR INSTALAÇÃO' => array('REAGENDAR INSTALAÇÃO'),
								'REAGENDAR INSTALAÇÃO' => array(),
								'INSTALADO' => array(),
								'CANCELADO' => array(),
								'FINALIZADA' => array()
