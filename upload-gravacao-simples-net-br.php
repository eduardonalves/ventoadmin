...
if(isset($_POST['upload']))
{
	...
	foreach($_FILES["gravacao"]["error"] as $key => $error)
	{
		...
		if($error == UPLOAD_ERR_OK)
		{
			...
			$backupGravacoes = "gravacoes/net/" . $data;
...
<form name="gravacoes" action="http://vem.techinmove.com.br/upload-gravacao-simples-net.php?id=<?php echo $_GET["id"]; ?>&u=<?php echo $_GET["u"]; ?>" enctype="multipart/form-data" method="post">
