...
<? } else if(($editar == '1') && $linha['status'] == 'ENTREGAR') { ?>
...
<? } else if( ($_GET['e'] == '1') && $linha['status'] == 'SEM CONTATO'  && ( ($USUARIO['tipo_usuario']!="MONITOR" && $USUARIO['acesso_usuario']!="EXTERNO") || ( $USUARIO['tipo_usuario']=="MONITOR" && $USUARIO['acesso_usuario']=="INTERNO") )) { ?>
...
<? if($USUARIO['editar_dados'] == 1 || $USUARIO['editar_instalacao'] == 1 || ($USUARIO['tipo_usuario'] == 'LOGISTICA') || ($USUARIO['tipo_usuario'] == 'MONITOR' && ($linha['status'] == 'DEVOLVIDO' || $linha['status'] == 'SEM CONTATO') ) ){?>
