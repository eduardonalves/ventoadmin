...
$conRESTRICAO = $conexao->query("SELECT * FROM vendas_clarotv  WHERE produto = '3' && data LIKE '%".$ano.$mes.$dia."%' && status = 'RESTRIÇÃO' && monitor LIKE '%".$loginMONITOR."%'");
    ...
    <body>
        ...
        <div id="legenda">
        	<a href="../../adm?ve=1&me=<?= $mes;?>&an=<?= $ano;?>&p=clarofixo&o=&m=&t=&f=&s=RESTRI%C7%C3O&v=&i=&de=&di=&tpv=&b=" target="_top">
            	<span class="qdr1" title="Visualizar vendas no status Restrição"></span>
            </a> 
            <span class="leg1">Restrição <span style="font-size:10px">(<?= $totalRESTRICAO;?>)</span></span> 
