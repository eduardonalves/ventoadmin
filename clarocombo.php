...
$set_colunas = $conexao->query("UPDATE usuarios SET colunas_clarocombo = '(".$_POST['chk1'].") (".$_POST['chk2'].") (".$_POST['chk3'].") (".$_POST['chk4'].") (".$_POST['chk5'].") (".$_POST['chk6'].") (".$_POST['chk7'].") (".$_POST['chk8'].") (".$_POST['chk9'].") (".$_POST['chk10'].") (".$_POST['chk11'].") (".$_POST['chk12'].") (".$_POST['chk13'].") (".$_POST['chk14'].") (".$_POST['chk15'].") (".$_POST['chk16'].") (".$_POST['chk17'].") (".$_POST['chk18'].") (".$_POST['chk19'].") (".$_POST['chk20'].") (".$_POST['chk21'].") (".$_POST['chk22'].") (".$_POST['chk23'].") (".$_POST['chk24'].") (".$_POST['chk25'].") (".$_POST['chk26'].") (".$_POST['chk27'].") (".$_POST['chk28'].") (".$_POST['chk29'].") (".$_POST['chk30'].") (".$_POST['chk31'].") (".$_POST['chk32'].") (".$_POST['chk33'].") (".$_POST['chk34'].") (".$_POST['chk35'].") (".$_POST['chk36'].")' WHERE id = '".$USUARIO['id']."'");	
?>	
...
<tr align="left">
<td width="50%"><input type="checkbox" name="chk1" <? if(strstr($USUARIO['colunas_clarocombo'],'(os)')){?>checked="checked"<? } ?> value="os" /> 
<?= strtoupper($campo->os);?></td>
<td width="50%"><input type="checkbox" name="chk2" <? if(strstr($USUARIO['colunas_clarocombo'],'(vencimento)')){?>checked="checked"<? } ?> value="vencimento" /> <?= $campo->vencimento;?></td>
</tr>
<tr align="left">
<td><input type="checkbox" name="chk3" <? if(strstr($USUARIO['colunas_clarocombo'],'(contrato)')){?>checked="checked"<? } ?> value="contrato" /> <?= strtoupper($campo->contrato);?></td>
<td><input type="checkbox" name="chk4" <? if(strstr($USUARIO['colunas_clarocombo'],'(valor)')){?>checked="checked"<? } ?> value="valor" /> <?= strtoupper($campo->valor);?></td>
</tr>
<tr align="left">
<td><input type="checkbox" name="chk5" <? if(strstr($USUARIO['colunas_clarocombo'],'(nome)')){?>checked="checked"<? } ?> value="nome" /> <?= strtoupper($campo->cliente);?></td>
<td><input type="checkbox" name="chk6" <? if(strstr($USUARIO['colunas_clarocombo'],'(pagamento)')){?>checked="checked"<? } ?> value="pagamento" /> <?= strtoupper($campo->pagamento);?></td>
</tr>
<tr align="left">
<td><input type="checkbox" name="chk7" <? if(strstr($USUARIO['colunas_clarocombo'],'(cpf)')){?>checked="checked"<? } ?> value="cpf" /> <?= strtoupper($campo->cpf);?></td>
<td><input type="checkbox" name="chk8" <? if(strstr($USUARIO['colunas_clarocombo'],'(data)')){?>checked="checked"<? } ?> value="data" /> <?= strtoupper($campo->data);?></td>
</tr>
<tr align="left">
<td><input type="checkbox" name="chk9" <? if(strstr($USUARIO['colunas_clarocombo'],'(telefone)')){?>checked="checked"<? } ?> value="telefone" /> <?= strtoupper($campo->telefone);?></td>
<td><input type="checkbox" name="chk10" <? if(strstr($USUARIO['colunas_clarocombo'],'(data_marcada)')){?>checked="checked"<? } ?> value="data_marcada" /> <?= strtoupper($campo->data_marcada);?></td>
</tr>
<tr align="left">
<td><input type="checkbox" name="chk11" <? if(strstr($USUARIO['colunas_clarocombo'],'(email)')){?>checked="checked"<? } ?> value="email" /> <?= strtoupper($campo->email);?></td>
<td><input type="checkbox" name="chk12" <? if(strstr($USUARIO['colunas_clarocombo'],'(comboServicos)')){?>checked="checked"<? } ?> value="comboServicos" /> SERVIÇOS </td>
</tr>
<tr align="left">
<td><input type="checkbox" name="chk13" <? if(strstr($USUARIO['colunas_clarocombo'],'(comboFonePlano)')){?>checked="checked"<? } ?> value="comboFonePlano" /> PLANO FONE</td>
<td><input type="checkbox" name="chk14" <? if(strstr($USUARIO['colunas_clarocombo'],'(comboFonePlanoPreco)')){?>checked="checked"<? } ?> value="comboFonePlanoPreco" /> PREÇO PLANO FONE </td>
</tr>
<tr align="left">
<td><input type="checkbox" name="chk15" <? if(strstr($USUARIO['colunas_clarocombo'],'(comboInternetPlano)')){?>checked="checked"<? } ?> value="comboInternetPlano" /> PLANO INTERNET</td>
<td><input type="checkbox" name="chk16" <? if(strstr($USUARIO['colunas_clarocombo'],'(comboInternetPlanoPreco)')){?>checked="checked"<? } ?> value="comboInternetPlanoPreco" /> PREÇO PLANO INTERNET </td>
</tr>
<tr align="left">
<td><input type="checkbox" name="chk17" <? if(strstr($USUARIO['colunas_clarocombo'],'(comboTotalPlanos)')){?>checked="checked"<? } ?> value="comboTotalPlanos" /> TOTAL PLANOS</td>
<td><input type="checkbox" name="chk18" <? if(strstr($USUARIO['colunas_clarocombo'],'(comboPortabilidade)')){?>checked="checked"<? } ?> value="comboPortabilidade" /> PORTABILIDADE </td>
</tr>
<tr align="left">
<td><input type="checkbox" name="chk19" <? if(strstr($USUARIO['colunas_clarocombo'],'(comboNumeroPortado)')){?>checked="checked"<? } ?> value="comboNumeroPortado" /> NÚMERO PORTADO</td>
<td><input type="checkbox" name="chk20" <? if(strstr($USUARIO['colunas_clarocombo'],'(comboRoteador)')){?>checked="checked"<? } ?> value="comboRoteador" /> ROTEADOR </td>
</tr>
<tr align="left">
<td><input type="checkbox" name="chk21" <? if(strstr($USUARIO['colunas_clarocombo'],'(comboRoteadorPreco)')){?>checked="checked"<? } ?> value="comboRoteadorPreco" /> PREÇO ROTEADOR</td>
<td><input type="checkbox" name="chk22" <? if(strstr($USUARIO['colunas_clarocombo'],'(comboClienteTv)')){?>checked="checked"<? } ?> value="comboClienteTv" /> CLIENTE TV </td>
</tr>

<tr align="left">
<td><input type="checkbox" name="chk23" <? if(strstr($USUARIO['colunas_clarocombo'],'(endereco)')){?>checked="checked"<? } ?>  value="endereco" /> <?= strtoupper(utf8_decode($campo->endereco));?></td>
<td><input type="checkbox" name="chk24" <? if(strstr($USUARIO['colunas_clarocombo'],'(cep)')){?>checked="checked"<? } ?> value="cep" /> <?= strtoupper($campo->cep);?></td>
</tr>
<tr align="left">
<td><input type="checkbox" name="chk25" <? if(strstr($USUARIO['colunas_clarocombo'],'(tecnico)')){?>checked="checked"<? } ?> value="tecnico" /> <?= strtoupper(utf8_decode($campo->tecnico));?></td>
<td><input type="checkbox" name="chk26" <? if(strstr($USUARIO['colunas_clarocombo'],'(plano)')){?>checked="checked"<? } ?> value="plano" /> <?= strtoupper($campo->plano);?></td>
</tr>
<tr align="left">
<td><input type="checkbox" name="chk27" <? if(strstr($USUARIO['colunas_clarocombo'],'(status)')){?>checked="checked"<? } ?> value="status" /> <?= strtoupper($campo->status);?></td>
<td><input type="checkbox" name="chk28" <? if(strstr($USUARIO['colunas_clarocombo'],'(proposta)')){?>checked="checked"<? } ?> value="proposta" /> <?= strtoupper($campo->proposta);?></td>
</tr>
<tr align="left">
<td><input type="checkbox" name="chk29" <? if(strstr($USUARIO['colunas_clarocombo'],'(monitor)')){?>checked="checked"<? } ?> value="monitor" /> <?= strtoupper($campo->monitor);?></td>
<td><input type="checkbox" name="chk30" <? if(strstr($USUARIO['colunas_clarocombo'],'(operador)')){?>checked="checked"<? } ?> value="operador" /> <?= strtoupper($campo->operador);?></td>
</tr>
<tr align="left">
<td><input type="checkbox" name="chk31" <? if(strstr($USUARIO['colunas_clarocombo'],'(cidade)')){?>checked="checked"<? } ?> value="cidade" /> <?= strtoupper($campo->cidade);?></td>
<td><input type="checkbox" name="chk32" <? if(strstr($USUARIO['colunas_clarocombo'],'(motivo_cancelamento)')){?>checked="checked"<? } ?> value="motivo_cancelamento" /> Motivo Cancelamento</td>
</tr>
<tr align="left">
<td><input type="checkbox" name="chk33" <? if(strstr($USUARIO['colunas_clarocombo'],'(tipo_venda)')){?>checked="checked"<? } ?> value="tipo_venda" /> Tipo Venda</td>
<td width="50%"><input type="checkbox" name="chk34" <? if(strstr($USUARIO['colunas_clarocombo'],'(motivo_analise)')){?>checked="checked"<? } ?> value="motivo_analise" /> Motivo Análise</td>
</tr>
<tr align="left">
<td width="50%"><input type="checkbox" name="chk35" <? if(strstr($USUARIO['colunas_clarocombo'],'(agendamento_gravacao)')){?>checked="checked"<? } ?> value="agendamento_gravacao" /> Agend. Gravação</td>
<td><input type="checkbox" name="chk36" <? if(strstr($USUARIO['colunas_clarotv'],'(data_instalacao)')){?>checked="checked"<? } ?> value="data_instalacao" /> <?= strtoupper(utf8_decode($campo->data_instalacao));?></td>
<td></td>
</tr>
...
include "includes/filtro-clarocombo.php";
?>
...
<? if(strstr($USUARIO['colunas_clarocombo'],'(telefone)')){?>
...
<? if(strstr($USUARIO['colunas_clarocombo'],'(email)')){?>
...
<? if(strstr($USUARIO['colunas_clarocombo'],'(comboServicos)')){?>
<td title="Serviços do combo" onclick="window.location = '?p=clarocombo&m=<?= $_GET['m'];?>&t=<?= $_GET['t'];?>&f=<?= $_GET['f'];?>&s=<?= $_GET['s'];?>&v=<?= $_GET['v'];?>&i=<?= $_GET['i'];?>&b=<?= $_GET['b'];?>&tpv=<?= $_GET['tpv']; ?>&pg=<?php echo ($pg - 1); ?>&di=<?= $_GET['di']; ?>&me=<?= $_GET['me']; ?>&an=<?= $_GET['an']; ?>&ve=<?= $_GET['ve']; ?>&ate=<?= $_GET['ate']; ?>&g=<?= $_GET['g']; ?>&o=<? if($_GET['o'] != 'vendas_clarotv.comboServicos DESC'){ echo 'vendas_clarotv.comboServicos DESC'; } else { echo 'vendas_clarotv.comboServicos ASC'; }?>'">Serviços Combo <? if($_GET['o'] == 'vendas_clarotv.comboServicos DESC'){ ?><img src="img/seta-d.png" /> <? } else if($_GET['o'] == 'vendas_clarotv.comboServicos ASC'){ ?> <img src="img/seta-u.png" /> <? } ?></td>
<? } ?>

<? if(strstr($USUARIO['colunas_clarocombo'],'(comboFonePlano)')){?>
<td title="Plano Fone" onclick="window.location = '?p=clarocombo&m=<?= $_GET['m'];?>&t=<?= $_GET['t'];?>&f=<?= $_GET['f'];?>&s=<?= $_GET['s'];?>&v=<?= $_GET['v'];?>&i=<?= $_GET['i'];?>&b=<?= $_GET['b'];?>&tpv=<?= $_GET['tpv']; ?>&pg=<?php echo ($pg - 1); ?>&di=<?= $_GET['di']; ?>&me=<?= $_GET['me']; ?>&an=<?= $_GET['an']; ?>&ve=<?= $_GET['ve']; ?>&ate=<?= $_GET['ate']; ?>&g=<?= $_GET['g']; ?>&o=<? if($_GET['o'] != 'vendas_clarotv.comboFonePlano DESC'){ echo 'vendas_clarotv.comboFonePlano DESC'; } else { echo 'vendas_clarotv.comboFonePlano ASC'; }?>'">Plano Fone <? if($_GET['o'] == 'vendas_clarotv.comboFonePlano DESC'){ ?><img src="img/seta-d.png" /> <? } else if($_GET['o'] == 'vendas_clarotv.comboFonePlano ASC'){ ?> <img src="img/seta-u.png" /> <? } ?></td>
<? } ?>

<? if(strstr($USUARIO['colunas_clarocombo'],'(comboFonePlanoPreco)')){?>
<td title="Preço Plano Fone" onclick="window.location = '?p=clarocombo&m=<?= $_GET['m'];?>&t=<?= $_GET['t'];?>&f=<?= $_GET['f'];?>&s=<?= $_GET['s'];?>&v=<?= $_GET['v'];?>&i=<?= $_GET['i'];?>&b=<?= $_GET['b'];?>&tpv=<?= $_GET['tpv']; ?>&pg=<?php echo ($pg - 1); ?>&di=<?= $_GET['di']; ?>&me=<?= $_GET['me']; ?>&an=<?= $_GET['an']; ?>&ve=<?= $_GET['ve']; ?>&ate=<?= $_GET['ate']; ?>&g=<?= $_GET['g']; ?>&o=<? if($_GET['o'] != 'vendas_clarotv.comboFonePlanoPreco DESC'){ echo 'vendas_clarotv.email DESC'; } else { echo 'vendas_clarotv.comboFonePlanoPreco ASC'; }?>'">Preço Plano Fone <? if($_GET['o'] == 'vendas_clarotv.comboFonePlanoPreco DESC'){ ?><img src="img/seta-d.png" /> <? } else if($_GET['o'] == 'vendas_clarotv.comboFonePlanoPreco ASC'){ ?> <img src="img/seta-u.png" /> <? } ?></td>
<? } ?>

<? if(strstr($USUARIO['colunas_clarocombo'],'(comboInternetPlano)')){?>
<td title="Plano Internet" onclick="window.location = '?p=clarocombo&m=<?= $_GET['m'];?>&t=<?= $_GET['t'];?>&f=<?= $_GET['f'];?>&s=<?= $_GET['s'];?>&v=<?= $_GET['v'];?>&i=<?= $_GET['i'];?>&b=<?= $_GET['b'];?>&tpv=<?= $_GET['tpv']; ?>&pg=<?php echo ($pg - 1); ?>&di=<?= $_GET['di']; ?>&me=<?= $_GET['me']; ?>&an=<?= $_GET['an']; ?>&ve=<?= $_GET['ve']; ?>&ate=<?= $_GET['ate']; ?>&g=<?= $_GET['g']; ?>&o=<? if($_GET['o'] != 'vendas_clarotv.comboInternetPlano DESC'){ echo 'vendas_clarotv.comboInternetPlano DESC'; } else { echo 'vendas_clarotv.comboInternetPlano ASC'; }?>'">Plano Internet <? if($_GET['o'] == 'vendas_clarotv.comboInternetPlano DESC'){ ?><img src="img/seta-d.png" /> <? } else if($_GET['o'] == 'vendas_clarotv.comboInternetPlano ASC'){ ?> <img src="img/seta-u.png" /> <? } ?></td>
<? } ?>

<? if(strstr($USUARIO['colunas_clarocombo'],'(comboInternetPlanoPreco)')){?>
<td title="Preço Plano Internet" onclick="window.location = '?p=clarocombo&m=<?= $_GET['m'];?>&t=<?= $_GET['t'];?>&f=<?= $_GET['f'];?>&s=<?= $_GET['s'];?>&v=<?= $_GET['v'];?>&i=<?= $_GET['i'];?>&b=<?= $_GET['b'];?>&tpv=<?= $_GET['tpv']; ?>&pg=<?php echo ($pg - 1); ?>&di=<?= $_GET['di']; ?>&me=<?= $_GET['me']; ?>&an=<?= $_GET['an']; ?>&ve=<?= $_GET['ve']; ?>&ate=<?= $_GET['ate']; ?>&g=<?= $_GET['g']; ?>&o=<? if($_GET['o'] != 'vendas_clarotv.comboInternetPlanoPreco DESC'){ echo 'vendas_clarotv.comboInternetPlanoPreco DESC'; } else { echo 'vendas_clarotv.comboInternetPlanoPreco ASC'; }?>'">Preço Plano Internet <? if($_GET['o'] == 'vendas_clarotv.comboInternetPlanoPreco DESC'){ ?><img src="img/seta-d.png" /> <? } else if($_GET['o'] == 'vendas_clarotv.comboInternetPlanoPreco ASC'){ ?> <img src="img/seta-u.png" /> <? } ?></td>
<? } ?>

<? if(strstr($USUARIO['colunas_clarocombo'],'(comboTotalPlanos)')){?>
<td title="Total dos Planos" onclick="window.location = '?p=clarocombo&m=<?= $_GET['m'];?>&t=<?= $_GET['t'];?>&f=<?= $_GET['f'];?>&s=<?= $_GET['s'];?>&v=<?= $_GET['v'];?>&i=<?= $_GET['i'];?>&b=<?= $_GET['b'];?>&tpv=<?= $_GET['tpv']; ?>&pg=<?php echo ($pg - 1); ?>&di=<?= $_GET['di']; ?>&me=<?= $_GET['me']; ?>&an=<?= $_GET['an']; ?>&ve=<?= $_GET['ve']; ?>&ate=<?= $_GET['ate']; ?>&g=<?= $_GET['g']; ?>&o=<? if($_GET['o'] != 'vendas_clarotv.comboTotalPlanos DESC'){ echo 'vendas_clarotv.comboTotalPlanos DESC'; } else { echo 'vendas_clarotv.comboTotalPlanos ASC'; }?>'">Total Planos <? if($_GET['o'] == 'vendas_clarotv.comboTotalPlanos DESC'){ ?><img src="img/seta-d.png" /> <? } else if($_GET['o'] == 'vendas_clarotv.comboTotalPlanos ASC'){ ?> <img src="img/seta-u.png" /> <? } ?></td>
<? } ?>

<? if(strstr($USUARIO['colunas_clarocombo'],'(comboPortabilidade)')){?>
<td title="Postabilidade" onclick="window.location = '?p=clarocombo&m=<?= $_GET['m'];?>&t=<?= $_GET['t'];?>&f=<?= $_GET['f'];?>&s=<?= $_GET['s'];?>&v=<?= $_GET['v'];?>&i=<?= $_GET['i'];?>&b=<?= $_GET['b'];?>&tpv=<?= $_GET['tpv']; ?>&pg=<?php echo ($pg - 1); ?>&di=<?= $_GET['di']; ?>&me=<?= $_GET['me']; ?>&an=<?= $_GET['an']; ?>&ve=<?= $_GET['ve']; ?>&ate=<?= $_GET['ate']; ?>&g=<?= $_GET['g']; ?>&o=<? if($_GET['o'] != 'vendas_clarotv.comboPortabilidade DESC'){ echo 'vendas_clarotv.comboPortabilidade DESC'; } else { echo 'vendas_clarotv.comboPortabilidade ASC'; }?>'">Portabilidade <? if($_GET['o'] == 'vendas_clarotv.comboPortabilidade DESC'){ ?><img src="img/seta-d.png" /> <? } else if($_GET['o'] == 'vendas_clarotv.comboPortabilidade ASC'){ ?> <img src="img/seta-u.png" /> <? } ?></td>
<? } ?>

<? if(strstr($USUARIO['colunas_clarocombo'],'(comboNumeroPortado)')){?>
<td title="Número Portado" onclick="window.location = '?p=clarocombo&m=<?= $_GET['m'];?>&t=<?= $_GET['t'];?>&f=<?= $_GET['f'];?>&s=<?= $_GET['s'];?>&v=<?= $_GET['v'];?>&i=<?= $_GET['i'];?>&b=<?= $_GET['b'];?>&tpv=<?= $_GET['tpv']; ?>&pg=<?php echo ($pg - 1); ?>&di=<?= $_GET['di']; ?>&me=<?= $_GET['me']; ?>&an=<?= $_GET['an']; ?>&ve=<?= $_GET['ve']; ?>&ate=<?= $_GET['ate']; ?>&g=<?= $_GET['g']; ?>&o=<? if($_GET['o'] != 'vendas_clarotv.comboNumeroPortado DESC'){ echo 'vendas_clarotv.comboNumeroPortado DESC'; } else { echo 'vendas_clarotv.comboNumeroPortado ASC'; }?>'">Número Portado <? if($_GET['o'] == 'vendas_clarotv.comboNumeroPortado DESC'){ ?><img src="img/seta-d.png" /> <? } else if($_GET['o'] == 'vendas_clarotv.comboNumeroPortado ASC'){ ?> <img src="img/seta-u.png" /> <? } ?></td>
<? } ?>

<? if(strstr($USUARIO['colunas_clarocombo'],'(comboRoteador)')){?>
<td title="Roteador" onclick="window.location = '?p=clarocombo&m=<?= $_GET['m'];?>&t=<?= $_GET['t'];?>&f=<?= $_GET['f'];?>&s=<?= $_GET['s'];?>&v=<?= $_GET['v'];?>&i=<?= $_GET['i'];?>&b=<?= $_GET['b'];?>&tpv=<?= $_GET['tpv']; ?>&pg=<?php echo ($pg - 1); ?>&di=<?= $_GET['di']; ?>&me=<?= $_GET['me']; ?>&an=<?= $_GET['an']; ?>&ve=<?= $_GET['ve']; ?>&ate=<?= $_GET['ate']; ?>&g=<?= $_GET['g']; ?>&o=<? if($_GET['o'] != 'vendas_clarotv.comboRoteador DESC'){ echo 'vendas_clarotv.comboRoteador DESC'; } else { echo 'vendas_clarotv.comboRoteador ASC'; }?>'">Roteador <? if($_GET['o'] == 'vendas_clarotv.comboRoteador DESC'){ ?><img src="img/seta-d.png" /> <? } else if($_GET['o'] == 'vendas_clarotv.comboRoteador ASC'){ ?> <img src="img/seta-u.png" /> <? } ?></td>
<? } ?>

<? if(strstr($USUARIO['colunas_clarocombo'],'(comboRoteadorPreco)')){?>
<td title="Preço Roteador" onclick="window.location = '?p=clarocombo&m=<?= $_GET['m'];?>&t=<?= $_GET['t'];?>&f=<?= $_GET['f'];?>&s=<?= $_GET['s'];?>&v=<?= $_GET['v'];?>&i=<?= $_GET['i'];?>&b=<?= $_GET['b'];?>&tpv=<?= $_GET['tpv']; ?>&pg=<?php echo ($pg - 1); ?>&di=<?= $_GET['di']; ?>&me=<?= $_GET['me']; ?>&an=<?= $_GET['an']; ?>&ve=<?= $_GET['ve']; ?>&ate=<?= $_GET['ate']; ?>&g=<?= $_GET['g']; ?>&o=<? if($_GET['o'] != 'vendas_clarotv.comboRoteadorPreco DESC'){ echo 'vendas_clarotv.comboRoteadorPreco DESC'; } else { echo 'vendas_clarotv.comboRoteadorPreco ASC'; }?>'">Preço Roteador <? if($_GET['o'] == 'vendas_clarotv.comboRoteadorPreco DESC'){ ?><img src="img/seta-d.png" /> <? } else if($_GET['o'] == 'vendas_clarotv.comboRoteadorPreco ASC'){ ?> <img src="img/seta-u.png" /> <? } ?></td>
<? } ?>

<? if(strstr($USUARIO['colunas_clarocombo'],'(comboClienteTv)')){?>
<td title="Cliente Tv?" onclick="window.location = '?p=clarocombo&m=<?= $_GET['m'];?>&t=<?= $_GET['t'];?>&f=<?= $_GET['f'];?>&s=<?= $_GET['s'];?>&v=<?= $_GET['v'];?>&i=<?= $_GET['i'];?>&b=<?= $_GET['b'];?>&tpv=<?= $_GET['tpv']; ?>&pg=<?php echo ($pg - 1); ?>&di=<?= $_GET['di']; ?>&me=<?= $_GET['me']; ?>&an=<?= $_GET['an']; ?>&ve=<?= $_GET['ve']; ?>&ate=<?= $_GET['ate']; ?>&g=<?= $_GET['g']; ?>&o=<? if($_GET['o'] != 'vendas_clarotv.comboClienteTv DESC'){ echo 'vendas_clarotv.comboClienteTv DESC'; } else { echo 'vendas_clarotv.comboClienteTv ASC'; }?>'">Cliente TV <? if($_GET['o'] == 'vendas_clarotv.comboClienteTv DESC'){ ?><img src="img/seta-d.png" /> <? } else if($_GET['o'] == 'vendas_clarotv.comboClienteTv ASC'){ ?> <img src="img/seta-u.png" /> <? } ?></td>
<? } ?>

<? if(strstr($USUARIO['colunas_clarocombo'],'(endereco)')){?>
...
<? if(strstr($USUARIO['colunas_clarocombo'],'(cidade)')){?>
...
<? if(strstr($USUARIO['colunas_clarocombo'],'(comboFonePlanoPreco)')){?>
<td title="Preço Plano Fone" <? if(strstr($_GET['o'],'comboFonePlanoPreco')){ ?>class="tdselected" <? } ?>><?= strtoupper($VENDA['comboFonePlanoPreco']);?></td>
<? } ?>
...
<? if(strstr($USUARIO['colunas_clarocombo'],'(comboInternetPlanoPreco)')){?>
<td title="Preço Plano Internet" <? if(strstr($_GET['o'],'comboInternetPlanoPreco')){ ?>class="tdselected" <? } ?>><?= strtoupper($VENDA['comboInternetPlanoPreco']);?></td>
<? } ?>

<? if(strstr($USUARIO['colunas_clarocombo'],'(comboTotalPlanos)')){?>
<td title="Valor Total Planos" <? if(strstr($_GET['o'],'comboTotalPlanos')){ ?>class="tdselected" <? } ?>><?= strtoupper($VENDA['comboTotalPlanos']);?></td>
<? } ?>

<? if(strstr($USUARIO['colunas_clarocombo'],'(comboPortabilidade)')){?>
<td title="Portabilidade" <? if(strstr($_GET['o'],'comboPortabilidade')){ ?>class="tdselected" <? } ?>><?= strtoupper($VENDA['comboPortabilidade']);?></td>
<? } ?>

<? if(strstr($USUARIO['colunas_clarocombo'],'(comboNumeroPortado)')){?>
<td title="Número Portado" <? if(strstr($_GET['o'],'comboNumeroPortado')){ ?>class="tdselected" <? } ?>><?= strtoupper($VENDA['comboNumeroPortado']);?></td>
<? } ?>

<? if(strstr($USUARIO['colunas_clarocombo'],'(comboRoteador)')){?>
<td title="Roteador" <? if(strstr($_GET['o'],'comboRoteador')){ ?>class="tdselected" <? } ?>><?= strtoupper($VENDA['comboRoteador']);?></td>
<? } ?>

<? if(strstr($USUARIO['colunas_clarocombo'],'(comboRoteadorPreco)')){?>
<td title="Preço Roteador" <? if(strstr($_GET['o'],'comboRoteadorPreco')){ ?>class="tdselected" <? } ?>><?= strtoupper($VENDA['comboRoteadorPreco']);?></td>
<? } ?>

<? if(strstr($USUARIO['colunas_clarocombo'],'(comboClienteTv)')){?>
<td title="Cliente TV" <? if(strstr($_GET['o'],'comboClienteTv')){ ?>class="tdselected" <? } ?>><?= strtoupper($VENDA['comboClienteTv']);?></td>
<? } ?>
...
<td width="26px" title="Editar Dados" style="cursor:pointer"><img src="img/icone-editar.png" width="13" height="13" onclick="Popup=window.open('detalhes-venda-clarocombo.php?e=1&id=<?= $VENDA['id']; ?>','Popup','toolbar=no,location=no,status=no,menubar=no,scrollbars=yes,resizable=no,width=630,height=600,left=430,top=30');" /></td>
<? } ?>

<td><input type="checkbox" name="id[]" onchange="check();" value="<?= $VENDA['id'];?>" /></td>

<td width="26px" title="Mais Detalhes" style="cursor:pointer"><img src="img/icone-mais.png" width="13" height="13" onclick="Popup=window.open('detalhes-venda-clarocombo.php?id=<?= $VENDA['id']; ?>','Popup','toolbar=no,location=no,status=no,menubar=no,scrollbars=yes,resizable=no,width=630,height=600,left=430,top=30');" /></td>
