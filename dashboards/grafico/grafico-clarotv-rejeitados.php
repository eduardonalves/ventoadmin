...
<html>
    ...
    <body>
        ...
        <div id="legenda">
        <span class="qdr1"></span> <span class="leg1">Devolv. <span style="font-size:10px">(<?= $total1;?>)</span></span> 
        <span class="qdr2"></span> <span class="leg2">Cancelado <span style="font-size:10px">(<?= $total2;?>)</span></span>
        <span class="qdr3"></span> <span class="leg3">Sem Cont. <span style="font-size:10px">(<?= $total3;?>)</span></span>
        </div>
    </body>
