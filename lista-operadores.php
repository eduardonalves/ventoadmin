 ...
 /*Cria uma função de nome mascara, onde o primeiro argumento passado é um dos
	...
	$(document).ready( function(){
		...
		$("[name='grupo[]']").change( function(){
			...
			$('.nochange', this).each( function(){
				
				var $sel = $(this).attr('data-value-inicial');
		...
		$("[name='grupo[]'] .nochange").click( function(){
		

			if  ( $(this).attr('data-value-inicial') == 'no' ) {
			...
			alert('Você não tem permissão para adicionar/remover o produto ' + $(this).html() + ' deste operador.');
...
if($_POST['grupo'] != ''){ $grupo = ", grupo = '".implode('|', $_POST['grupo'])."'";}
...
<tr bgcolor="#ededed">
	...
	<td rowspan="2" colspan="2">
		...
		<select multiple name="grupo[]" id="grupo" style="width:100%; font-size:12px;">
			<!-- 
			<option value=""></option>
			...
			<option value="0009" <? if($OPERADOR['grupooperador'] == '0009'){ ?>selected="selected" <? } ?>>CLaro Combo</option>
			<option value="0001|0009" <? if($OPERADOR['grupooperador'] == '0001|0009'){ ?>selected="selected" <? } ?>>Claro TV, Claro Combo</option>
			<option value="0001|0002|0009" <? if($OPERADOR['grupooperador'] == '0001|0002|0009'){ ?>selected="selected" <? } ?>>Claro TV, Claro 3G, Claro Combo</option>
			<option value="0001|0002|0003|0009" <? if($OPERADOR['grupooperador'] == '0001|0002|0003|0009'){ ?>selected="selected" <? } ?>>Claro TV, Claro 3G, Claro Fixo, Claro Combo</option>
			<option value="0001|0002|0003|0004|0009" <? if($OPERADOR['grupooperador'] == '0001|0002|0003|0004|0009'){ ?>selected="selected" <? } ?>>Claro TV, Claro 3G, Claro Fixo, Oi, Claro Combo</option>
			<option value="0002|0009" <? if($OPERADOR['grupooperador'] == '0002|0009'){ ?>selected="selected" <? } ?>>Claro 3G, Claro Combo</option>
			<option value="0002|0003|0009" <? if($OPERADOR['grupooperador'] == '0002|0003|0009'){ ?>selected="selected" <? } ?>>Claro 3G, Claro Fixo, Claro Combo</option>
			<option value="0002|0003|0004|0009" <? if($OPERADOR['grupooperador'] == '0002|0003|0004|0009'){ ?>selected="selected" <? } ?>>Claro 3g, Claro Fixo, Oi, Claro Combo</option>
			<option value="0003|0009" <? if($OPERADOR['grupooperador'] == '0003|0009'){ ?>selected="selected" <? } ?>>Claro Fixo, Claro Combo</option>
			<option value="0003|0004|0009" <? if($OPERADOR['grupooperador'] == '0003|0004|0009'){ ?>selected="selected" <? } ?>>Claro Fixo, Oi, Claro Combo</option>
			<option value="0004|0009" <? if($OPERADOR['grupooperador'] == '0004|0009'){ ?>selected="selected" <? } ?>>Oi, Claro Combo</option>
			<option value="0007" <? if($OPERADOR['grupooperador'] == '0007'){ ?>selected="selected" <? } ?>>Protection</option>
			<option value="0010" <? if($OPERADOR['grupooperador'] == '0010'){ ?>selected="selected" <? } ?>>NET</option>
			-->
			
			<?php 
			$userGrupos = explode('|', $USUARIO['grupo']);
			
			foreach ($userGrupos as $userGrupo){

				$grupoName = mysql_result($conexao->query('Select menu from menu where grupo=\'' . $userGrupo . '\''), 0 ,'menu');
				
				echo "<option value=\"$userGrupo\">$grupoName</option>";
				
			}
			?>
		</select>
		<span style="color:#4D4D4D">* Pressione CTRL para selecionar múltiplos produtos.</span>
	</td>
</tr>
<tr bgcolor="#ededed">
	<td colspan="2">
	<label for="nomemonitor" style="color:#4D4D4D">Monitor:</label>
...
<tr bgcolor="#CCC">
<td>
<select multiple style="width:100%; height:50px;" name="grupo[]" id="grupo">
<!--
<option value=""></option>
<option value="0004" <? if($OPERADOR['grupooperador'] == '0004'){ ?>selected="selected" <? } ?>>Oi</option>
<option value="0001|0004" <? if($OPERADOR['grupooperador'] == '0001|0004'){ ?>selected="selected" <? } ?>>Claro TV e Oi</option>
...
-->
			...
			$todosGrupos = $conexao->query('Select menu, grupo from menu where 1=1');
			
			while ( $curGrupo = mysql_fetch_assoc($todosGrupos)) {

				$estadoInicial = ( strstr($OPERADOR['grupooperador'], $curGrupo['grupo']) ) ? 'selected' : 'no';
				$selected = ($estadoInicial=='selected') ? 'selected="selected"' : '';
				$noClass = ( in_array($curGrupo['grupo'], $userGrupos) ) ? '' : 'nochange';
				
				echo "<option data-value-inicial=\"$estadoInicial\" class=\"$noClass\" value=\"".$curGrupo['grupo']."\" $selected>".$curGrupo['menu']."</option>";
...
else if($OPERADOR['grupooperador'] == '0010'){$produto = 'NET';} */

$userGrupos = explode('|', $OPERADOR['grupooperador']);
$produto = "";
...
foreach ($userGrupos as $userGrupo){
	...
	$produto .= ($produto=='') ? $grupoName : ', ' . $grupoName;
...
else if($OPERADOR['grupooperador'] == '0009'){$produto = 'CLaro Combo';}
else if($OPERADOR['grupooperador'] == '0001|0009'){$produto = 'Claro TV, Claro Combo';}
else if($OPERADOR['grupooperador'] == '0001|0002|0009'){$produto = 'Claro TV, Claro 3G, Claro Combo';}
else if($OPERADOR['grupooperador'] == '0001|0002|0003|0009'){$produto = 'Claro TV, Claro 3G, Claro Fixo, Claro Combo';}
else if($OPERADOR['grupooperador'] == '0001|0002|0003|0004|0009'){$produto = 'Claro TV, Claro 3G, Claro Fixo, Oi, Claro Combo';}
else if($OPERADOR['grupooperador'] == '0002|0009'){$produto = 'Claro 3G, Claro Combo';}
else if($OPERADOR['grupooperador'] == '0002|0003|0009'){$produto = 'Claro 3G, Claro Fixo, Claro Combo';}
else if($OPERADOR['grupooperador'] == '0002|0003|0004|0009'){$produto = 'Claro 3g, Claro Fixo, Oi, Claro Combo';}
else if($OPERADOR['grupooperador'] == '0003|0009'){$produto = 'Claro Fixo, Claro Combo';}
else if($OPERADOR['grupooperador'] == '0003|0004|0009'){$produto = 'Claro Fixo, Oi, Claro Combo';}
else if($OPERADOR['grupooperador'] == '0004|0009'){$produto = 'Oi, Claro Combo';}
else if($OPERADOR['grupooperador'] == '0007'){$produto = 'Protection';}
else if($OPERADOR['grupooperador'] == '0010'){$produto = 'Net';} */
...
<select multiple style="font-size: 11px;" name="grupo[]">
	<!-- 
<option value="0004" <? if($OPERADOR['grupooperador'] == '0004'){ ?>selected="selected" <? } ?>>Oi</option>
<option value="0001|0004" <? if($OPERADOR['grupooperador'] == '0001|0004'){ ?>selected="selected" <? } ?>>Claro TV e Oi</option>
<option value="0003|0004" <? if($OPERADOR['grupooperador'] == '0003|0004'){ ?>selected="selected" <? } ?>>Claro Fixo e Oi</option>
