...
if($_POST['status'] == strtoupper('FINALIZADA') && ($_POST['agendaentrega'] == "00/00/0000" || $_POST['agendaentrega'] == ""))
{
	...
	if( strtoupper($_POST['status'])=='FINALIZADA' )
	{
		...
		{
			$excep = array("lote", "quadra", "complemento", "os", "esn", "novonumero","numchip");
			validarCampos($campos, $excep);
			

		}elseif ($_POST['tipoEntrega']=='PRONTA ENTREGA') {
			
			$excep = array("lote", "quadra", "complemento","numchip");
			validarCampos($campos, $excep);
...
if (precoPromocional != '' && precoPromocional != undefined && precoPromocional=='<?php echo $linha['valorAparelho'];?>')
{
...
<? if( ($linha['telefone2'] != '' || $editar == '1' ) && ( ($USUARIO['tipo_usuario']!="MONITOR" && $USUARIO['acesso_usuario']!="EXTERNO") ) ){?>
...
<? if( ($linha['telefone3'] != '' || $editar == '1' ) && ( ($USUARIO['tipo_usuario']!="MONITOR" && $USUARIO['acesso_usuario']!="EXTERNO") ) ){?>
...
<td><b>Status:</b></td>
<td>
<? if ($linha['status']=='FINALIZADA' && $USUARIO['tipo_usuario'] != 'ADMINISTRADOR') {?>
...
<?} elseif($editar == '1' && ($USUARIO['tipo_usuario'] == 'ADMINISTRADOR' || ($USUARIO['id'] == '2' || $USUARIO['id'] == '3140')) && ( ($USUARIO['tipo_usuario']!="MONITOR" && $USUARIO['acesso_usuario']!="EXTERNO") )){?>  
...
<option value="ENVIAR GRAVAÇÃO" <? if($linha['status'] == 'ENVIAR GRAVAÇÃO'){?>selected="selected"<? } ?>>Enviar Gravação</option>
...
<?} elseif(($editar == '1' || $USUARIO['id']==3179) && $linha['status'] == 'PRE-ANALISE' && ( ($USUARIO['tipo_usuario']!="MONITOR" && $USUARIO['acesso_usuario']!="EXTERNO") )) { ?>
...
<?php } ?>
<? } else if(($editar == '1') && $linha['status'] == 'GRAVAR' && ( ($USUARIO['tipo_usuario']!="MONITOR" && $USUARIO['acesso_usuario']!="EXTERNO") )) { ?>
...
<option value="DEVOLVIDO" <? if($linha['status'] == 'DEVOLVIDO'){?>selected="selected"<? } ?>>Devolvido</option>
<option value="RECUPERADO" <? if($linha['status'] == 'RECUPERADO'){?>selected="selected"<? } ?>>Venda Recuperada</option>
<?php /*/ <option value="PENDENTE" <? if($linha['status'] == 'PENDENTE'){?>selected="selected"<? } ?>>Pendente</option> */?>
<option value="CANCELADO" <? if($linha['status'] == 'CANCELADO'){?>selected="selected"<? } ?>>Cancelado</option>
</select>
...
<? } else if(($editar == '1') && $linha['status'] == 'GRAVADO' && ( ($USUARIO['tipo_usuario']!="MONITOR" && $USUARIO['acesso_usuario']!="EXTERNO") )) { ?>
...
<? } else if(($editar == '1') && $linha['status'] == 'SEM COBERTURA' && ( ($USUARIO['tipo_usuario']!="MONITOR" && $USUARIO['acesso_usuario']!="EXTERNO") )) { ?>
...
<? } else if(($editar == '1') && $linha['status'] == 'BOLETO GERADO' && ( ($USUARIO['tipo_usuario']!="MONITOR" && $USUARIO['acesso_usuario']!="EXTERNO") )) { ?>
...
<? } else if(($editar == '1' || $editar_instalacao == '1') && $linha['status'] == 'ENVIAR GRAVAÇÃO' && ( ($USUARIO['tipo_usuario']!="MONITOR" && $USUARIO['acesso_usuario']!="EXTERNO") )) { ?>

<select name="status" onChange="checkstatus(this.value)">
<option value="ENVIAR GRAVAÇÃO" <? if($linha['status'] == 'ENVIAR GRAVAÇÃO'){?>selected="selected"<? } ?>>Enviar Gravação</option>GRAVAÇÃO
<option value="FINALIZADA" <? if($linha['status'] == 'FINALIZADA'){?>selected="selected"<? } ?>>Finalizada</option>
</select>

<? } else if(($editar == '1') && $linha['status'] == 'RESTRIÇÃO' && ( ($USUARIO['tipo_usuario']!="MONITOR" && $USUARIO['acesso_usuario']!="EXTERNO") )) { ?>
...
<? } else if(($editar == '1') && $linha['status'] == 'AUTORIZADA' && ( ($USUARIO['tipo_usuario']!="MONITOR" && $USUARIO['acesso_usuario']!="EXTERNO") )) { ?>
...
<? } else if(($editar == '1') && $linha['status'] == 'SEM CONTATO'  && ( ($USUARIO['tipo_usuario']!="MONITOR" && $USUARIO['acesso_usuario']!="EXTERNO") || ( $USUARIO['tipo_usuario']=="MONITOR" && $USUARIO['acesso_usuario']=="INTERNO") )) { ?>
...
<?php /* <option value="DEVOLVIDO" <? if($linha['status'] == 'DEVOLVIDO'){?>selected="selected"<? } ?>>Devolvido</option>
<option value="GRAVADO" <? if($linha['status'] == 'GRAVADO'){?>selected="selected"<? } ?>>Gravado</option>
* */ ?>
