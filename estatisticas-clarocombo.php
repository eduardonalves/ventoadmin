...
function mostrarinfo(id){
	...
	$('#infooperador .load').load("includes/infooperador-clarocombo.php?id="+id+"&pro=<?= $produto_id;?>&m=<?= $mes;?>&an=<?= $ano;?>", function(){
...
<td style="font-size:14px; color:#999;">ESTAT&Iacute;STICAS (CLARO COMBO)</td>
