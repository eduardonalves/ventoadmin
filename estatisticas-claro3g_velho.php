...
<td bgcolor="#ceedfc" width="100px">Número de Autorizações</td>
<td bgcolor="#77c8f0"> &nbsp; Percentual de Autorizações &nbsp; </td>
...
echo '<b style="font-size:14px;">VENDAS: '.$numINFOOPERADOR.'</b> &nbsp; &nbsp; <b>Autorizadas:</b> '.$numINFOOPERADORCONEC.' &nbsp; <b>Restrições:</b> '.$numINFOOPERADORREST.' &nbsp; <b>Canceladas:</b> '.$numINFOOPERADORCANC; } ?></span></span>
...
<td width="100px">Data Autorização</td>
<td width="26px"></td>
</tr>
</table>
...
<td title="Data Início" onclick="window.location = '?p=estatisticas-claro3g&m=<?= $_GET['m'];?>&an=<?= $_GET['an'];?>&es=<?= $_GET['es'];?>&o=<? if($_GET['o'] == 'operadorData ASC'){ echo 'operadorData DESC'; } else { echo 'operadorData ASC'; }?>'">Data Início <? if($_GET['o'] == 'operadorData ASC'){ ?><img src="img/seta-u.png" /> <? } else if($_GET['o'] == 'operadorData DESC'){ ?> <img src="img/seta-d.png" /> <? } ?></td>
