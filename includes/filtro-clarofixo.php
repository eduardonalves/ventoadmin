...
/*
      ...
      END AS status_processo
		...
		LEFT OUTER JOIN qualidades ON ( qualidades.qualidade_id = (Select q.qualidade_id from qualidades q where (q.novo_numero=vendas.novoNumero && q.os=vendas.os) || (q.novo_numero=vendas.novoNumero && q.os='') order by status_portal desc, q.status_data desc, q.created desc limit 1) )
...
//select SUBSTRING(data,0,4) as data from vendas_clarotv limit 1
